...
const senderKeys: KeyInfo = {
  address: 'X-fuji1mspxw9pcjmjzca39ykakx9sl29rjzkzqhjkwkm',
  publicKey: '8k4CQDKG1DFVe7Z1jK5cprz6y2QunZbba7HFTHs4PHSGECc45o',
  privateKey: 'PrivateKey-zBCLzGzaNi82PfpWk2gZykp8h1ATBn4s5xL21RKkzuFe69r8c'
};
const assetID = "X1u9htMAisDm2BHVTLJ141LbCByPLWQKvGkxUEQACmH1sNA3W"; // the transaction ID is used as asset ID
const friendsAddress = 'X-fuji16t5r9xjjdallz9g2gee6rvjtt20sl64sn42mnw'; // address format is Bech32
// ============ Main Part of Script ===================
